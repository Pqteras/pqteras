  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          className={`self-start justify-between w-full`}
        ...
        <Section
          ...
          text={
            <>
              My coding journey ignited a passion for JavaScript, highlighted by
              Discord projects using
              {` `}
              <Links text={`discord.js`} link={`https://discord.js.org/`} />.
              I'm beyond a beginner but always eager to learn more. I have a
              solid grasp of HTML, CSS and {` `}
              <Links
                text={`electron.js`}
                link={`https://www.electronjs.org/`}
              />{" "}
              and am gradually advancing in {` `}
              <Links text={`React.js`} link={`https://react.dev/`} />.
            </>
          }
        />
        <Analytics />
